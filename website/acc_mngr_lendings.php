			...
			<div class="col-md-3">
				<table style="width:200px;"><tr>
					<td style="vertical-align:top;">
						<div style="#c_show_link_to_lender#">
							<a href=/acc_viewuser.php?userid=#c_lender_userid# target=_blank><img src="#c_photo_lender#" class="first_page_image user_thumbnail" style="width:40px; height:40px; margin:0 auto 0 auto;" id="image_lender_#c_transactionid#"></a>
						</div>
						<div style="#c_hide_link_to_lender#">
							<img src="#c_photo_lender#" class="first_page_image user_thumbnail" style="width:40px; height:40px; margin:0 auto 0 auto;" id="image_lender_#c_transactionid#">
							<span class="description" style="display:block; text-align:center;" id="name_lender_#c_transactionid#">#c_lender_userid# #c_lender_websiteid#</span>
						</div>
					</td>
...
$row_eval = '
	...
	if ( $row["c_lender_from_this_site"] ) {
		if ( file_exists("'.DIR_WS_WEBSITE_PHOTOS.'".$row["c_lender_userid"].".jpg") ) 
			$row["c_photo_lender"] = "/'.DIR_WS_WEBSITE_PHOTOS_DIR.'".$row["c_lender_userid"].".jpg";
	}
	...
	$row["c_show_link_to_lender"] = "display:none;";
	$row["c_hide_link_to_lender"] = "display:none;";
	if ( $row["c_lender_from_this_site"] ) {
		$row["c_show_link_to_lender"] = "";
	}
	else {
		$row["c_hide_link_to_lender"] = "";
	}
...
function show_amortization_schedule(amount, term, rate, created_unix_timestamp, transactionid)
{
	...
	var i = rate / 100 * <?php echo LOAN_PP_INTERVAL; ?>; // per week
	...
	try {
		$.ajax({
			...
			data: { userid: "<?php echo $user_account->userid; ?>", token: "<?php echo $user_account->psw_hash; ?>", table_name: "loans", sort_column: "8", sort_order: "ASC", row_number: "0", current_page_number: "0", max_ros: "500", installments_from_user: "<?php echo $user_account->userid; ?>", transactions_global_transactionid: transactionid }
		})
