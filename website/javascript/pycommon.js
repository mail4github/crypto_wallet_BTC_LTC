...
function utf8_encode( str_data ) {	// Encodes an ISO-8859-1 string to UTF-8
	...
	try
	{
		...
		console.log("utf8_encode exception: " + e);
	}
	return utftext;
}
...
function scorePassword(pass, strong_sign, good_sign, weak_sign) {
	if (typeof strong_sign == "undefined" ) 
		strong_sign = "Strong";
	if (typeof good_sign == "undefined" ) 
		good_sign = "Good";
	if (typeof weak_sign == "undefined" ) 
		weak_sign = "Weak";
    ...
    if (score > 80) {
        ...
        $("#password_weakness_name").html(strong_sign);
	}
	else
    if (score > 60) {
        ...
        $("#password_weakness_name").html(good_sign);
	}
	else {
		...
		$("#password_weakness_name").html(weak_sign);
	}
}
